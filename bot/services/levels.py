...
def level_by_coins(coins: int) -> LevelInfo:
    ...
    if next_base is None:
        return LevelInfo(level=level, current_base=current_base, next_base=None,
                         progress_percent=100, to_next=None)
    ...
    return LevelInfo(level=level, current_base=current_base, next_base=next_base,
                     progress_percent=min(100, percent), to_next=to_next)
